 ...
 *
 */
public class DailyRollingAppenderDecorator extends DailyRollingFileAppender implements Cloneable {
	...
	public DailyRollingAppenderDecorator() {
		super();
	}

	public DailyRollingAppenderDecorator(Layout layout, String filename, String datePattern) throws IOException {
		super(layout, filename, datePattern);
	}

	public DailyRollingAppenderDecorator(DailyRollingAppenderDecorator fileAppender, String threadName)
			throws IOException {
	...
	public String getFileName(String threadName) {
		return this.filePath + File.separator + threadName + File.separator + this.threadLogFileName;
	}
}
